package cn.haoyu.jclient.handler;
 ...
 */
public class HaoClientAioHandler implements AioHandler,ClientAioHandler {
	private Logger logger = LoggerFactory.getLogger(HaoClientAioHandler.class);
